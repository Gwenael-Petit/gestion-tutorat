...
/**
 * Class permetant de generer des graphes et de calculer des affectations en foctions de ces graphes
 * Les graphes sont generer a partir de criteres que l'on peut activer et desactiver
 */ 
public abstract class Graph {
    ...
    /**
     * Permet de trier une liste de tutores donnee dans une matiere en fonctions des absences
     * Cela permet d'activer le critere des absences pour les affectations
     * @param tutore : Liste de tutores
     * @param subjectID : Entier identifiant une matiere
     */
    ...
    /**
     * Permet de trier une liste de tutores donnee dans une matiere en excluant les absences
     * Cela permet de desactiver le critere des absences pour les affectations
     * @param tutore : Liste de tutores
     * @param subjectID : Entier identifiant une matiere
     */
    ...
    /**
     * Permet de trier une liste de tuteur donnee dans une matiere en fonctions de la moyenne de premiere annee
     * Cela permet d'activer le critere de moyenne de premiere annee pour les affectations
    ...
    /**
     * Permet de trier une liste de tuteur donnee dans une matiere en excluant la moyenne de premiere annee
     * Cela permet de desactiver le critere de moyenne de premiere annee pour les affectations
     * @param tutor : Liste de tuteurs
     * @param subjectID : Entier identifiant une matiere
     */
