...
/**
 * Classe qui cree un tuteur � partir d'un Student
 */
public class Tutor extends Student implements Cloneable{
    ...
    // Un booléen permettant de savoir si le critére des moyenne de premiéres sont activé
    boolean moyPremiere;
    ...
    /**
     * Renvoie un clone d'un tuteur, dans le cas o� on voudrait l'affecter a plusieurs tutores par exemple
     */
    ...
    /**
     *  Getter pour moyPremiere
     */
    public boolean isMoyPremiere() { return moyPremiere; }

    /**
     * Setter pour moy premiere
     */
