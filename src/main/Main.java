...
public abstract class Main {
    ...
    public static int getSubjectID(BufferedReader br) {
        ...
        while (idx <= 0 || idx >= 5) { // Si la matiere n'existe pas on continue de boucler
            System.out.println("Quelle matiere vous interesse ?");
            try {
        ...
        if (wait[idx].getTutor().size() > 0) {
            ...
            while (flag) {
                ...
                if (in.equals("M")) {
                    ...
                    // TODO : ajouter un message pour dire combien on en a elimine
                } else if (in.equals("P")) {
                ...
                if (in.equals("M")) {
                    ...
                    while (nb < 0) {
                        try {
                            ...
                            nb = Double.parseDouble(in);
                            if (nb < 0) {
                                throw new Exception("La valeur ne peut pas Ãªtre inferieur a 0 !");
                            }
                        } catch (IOException e) {
                            System.out.println("EntrÃ©e incorrecte !");
                        } catch (NumberFormatException e) {
     ...
     * @return calcul : le calcul d'affectation à la fin de la gestion des affectations tuteurs/tutores
     */
    ...
    /**
     * Renvoie les informations par rapport a la situation du tuteur donne en parametre dans une matiere, soit il n'existe pas et donc est crée, soit il est en file d'attente, soit il est affecte avec un/plusieurs tutores et le mail de son/ses tutore(s) est/sont envoyé(s) 
